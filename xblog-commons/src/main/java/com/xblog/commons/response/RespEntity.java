...
public class RespEntity {
    ...
    public static RespEntity success(Object object, String respMsg){
        return new RespEntity.RespEntityBuilder()
                .respCode(RespCode.success)
                .respMsg(respMsg)
                .data(object)
    ...
    public static RespEntity success(String respMsg){
        return new RespEntity.RespEntityBuilder()
                .respCode(RespCode.success)
                .respMsg(respMsg)
                .build();
    ...
    public static RespEntity error(String respCode){
        return new RespEntity.RespEntityBuilder()
                .respMsg(getFileMsg(respCode))
                .respCode(respCode)
                .build();
    }
